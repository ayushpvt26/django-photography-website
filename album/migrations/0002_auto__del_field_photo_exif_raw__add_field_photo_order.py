...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Photo.exif_raw'
        db.delete_column('album_photo', 'exif_raw')

        # Adding field 'Photo.order'
        db.add_column('album_photo', 'order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Photo.exif_raw'
        db.add_column('album_photo', 'exif_raw',
