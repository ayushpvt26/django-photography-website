...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('album_photo', 'date_time_taken', self.gf('django.db.models.fields.DateTimeField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Photo.date_time_taken'
        db.alter_column('album_photo', 'date_time_taken', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 15, 0, 0), max_length=150))
    ...
    models = {
        ...
        'album.photo': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_time_taken': ('django.db.models.fields.DateTimeField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
