...
from apps.album.views import EventPhotoDetailView, AlbumPhotoDetailView
...
urlpatterns = patterns('',
    ...
    url(r'^albums/(?P<collection_slug>[\w\-]+)/(?P<slug>[\w\-]+)/$', AlbumPhotoDetailView.as_view(), name='album-photo-detail'),
    url(r'^events/(?P<collection_slug>[\w\-]+)/(?P<slug>[\w\-]+)/$', EventPhotoDetailView.as_view(), name='event-photo-detail'),
